...
export const activityTemplates: Activity[] = [
  {
    ...
    wordPairs: [
      ...
      { word: "el mostrador", translation: "check-in counter" },
      { word: "la taquilla", translation: "ticket booth" },
      { word: "el andén", translation: "platform" },
      { word: "el vagón", translation: "train car" },
      { word: "la litera", translation: "sleeping berth / bunk (on a train)" },
      { word: "la sala de espera", translation: "waiting room" },
      { word: "el equipaje", translation: "luggage" },
      { word: "la maleta", translation: "suitcase" },
      { word: "el boleto", translation: "ticket" },
      { word: "el pase de abordar", translation: "boarding pass" },
      { word: "el pasaporte", translation: "passport" },
      { word: "la visa", translation: "visa" },
      { word: "la aduana", translation: "customs" },
      { word: "el piloto", translation: "pilot" },
      { word: "el revisor", translation: "train conductor / ticket inspector" },
      { word: "el pasajero", translation: "passenger" },
      { word: "el agente", translation: "agent" },
      { word: "el vuelo", translation: "flight" },
      { word: "la salida", translation: "departure" },
      { word: "la llegada", translation: "arrival" },
      { word: "la parada", translation: "stop" },
      { word: "el destino", translation: "destination" },
      { word: "retrasado", translation: "delayed" },
      { word: "a tiempo", translation: "on time" },
      { word: "en seguida", translation: "right away" },
      { word: "facturar el equipaje", translation: "to check luggage" },
      { word: "abordar", translation: "to board" },
      ...
      { word: "sacar", translation: "to take out" },
      { word: "buscar", translation: "to look for" },
...

  {
    ...
    description:
      "Match Linux commands to their functions and networking ports to their protocols/services.",
    variant: "four-choice",
    wordPairs: [
      {
        word: "cd",
      ...
      },
      {
        word: "ls -l",
        translation:
          "Lists files in a long format, showing details like permissions, ownership, and size.",
      },
      {
        word: "ls -R",
      ...
      },
      {
        word: "ps aux",
        translation:
          "Displays all running processes on the system, including those of other users.",
      },
      {
        word: "uname",
